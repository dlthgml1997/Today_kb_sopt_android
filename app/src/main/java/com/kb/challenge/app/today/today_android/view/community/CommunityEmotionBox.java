...
//            mParam2 = getArguments().getString(ARG_PARAM2);
    ...
    public void getEmotionBoxList() {
        ...
        Call<EmotionBoxResponse> requestDetail = networkService.getEmotionBoxList(SharedPreference.Companion.getInstance().getPrefStringData("data"), "2018-11-14");
        requestDetail.enqueue(new Callback<EmotionBoxResponse>() {
            ...
            public void onResponse(Call<EmotionBoxResponse> call, Response<EmotionBoxResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    ArrayList<EmotionBoxData> emotionBoxList = response.body().getResult();
