...
public class RecordFeelingEmotion extends DialogFragment {
    public static RecordFeelingEmotion newInstance(String title) {
        RecordFeelingEmotion frag = new RecordFeelingEmotion();
        return frag;
    }
